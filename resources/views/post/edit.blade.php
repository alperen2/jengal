                ...
                <div class="card-body">
                    ...
                    <form action="{{route('post.update', $post->id)}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" class="form-control summernote" name="detail" rows="4">
                                {{$post['detail']}}
                            </textarea>
                        </div>
                        <div class="row">
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="minPrice" value="{{ $post['minPrice'] }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="maxPrice" value="{{ $post['maxPrice'] }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-footer">
                            <input type="submit" value="Update the posting" class="btn btn-success float-right">
                        </div>
                    </form>
                </div>
                <!-- /.card -->
